...
<head>
    <meta charset="UTF-8">
    <title>Видалення товару - Stony</title>
...
<section class="content">
    <div class="heading-block">
        <div class="heading-block__text">
            <a href="/admin">Головна</a> / <a href="/admin/listTov">Список товарів</a> / Видалення товару - <?= /** @var TYPE_NAME $dataTov */
            $dataTov['name']?> <hr>
        </div>
        <div class="content-info">
            <div class="content-info__text">
                <form action="../../admin/deleteTov/<?=$dataTov['id']?>" method="POST" class="formDell">
                    <div class="label">Ви дійсно бажаєте видалити товар - <?=$dataTov['name']?> ?</div>
                    <img src="../templates/img/tov/<?=$dataTov['photo']?>"<br><br>
                    <input type="radio" name="dell" checked value="yes">Так
                    <input type="radio" name="dell" value="noy">Ні<br>
                    <input type="submit" class="button" name="deleteTov" id="deleteTov" value="Видалити">
                </form>
            </div>
        </div>
    </div>
